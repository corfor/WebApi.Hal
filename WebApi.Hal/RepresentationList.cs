...
namespace WebApi.Hal
{
    ...
    public abstract class RepresentationList<TRepresentation> : Representation, IRepresentationList, IEnumerable<TRepresentation>
        where TRepresentation : Representation
    {
        readonly IList<TRepresentation> resources;
        ...
        ///     Exception thrown - To be XML serializable, types which inherit from IEnumerable must have an implementation of
        ///     Add(System.Object)
        /// </summary>
